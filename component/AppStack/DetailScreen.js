            ...
            <ScrollView contentContainerStyle={{flex:1}}>
                <View style={{ flex: 1, paddingTop: 10, backgroundColor: 'white' }}>
                    ...
                    <View style={{ flex: 0.4, width: '100%', paddingTop: 10, justifyContent: 'flex-start', }}>
                        ...
                        <TouchableOpacity style={{ width: '100%', height: 50, backgroundColor: '#ff1654', justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ color: 'white', fontFamily: 'IRANSansMobile_Medium',fontSize:18 }}>رزرو آنلاین</Text>
                        </TouchableOpacity>
